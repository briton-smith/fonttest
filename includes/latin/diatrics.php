<div contenteditable="true">
	...
	<div class="dontprint">
		...
		<input type="range" min="0.6" max="2" value="1.2" step="0.05" oninput="changeLineHeigthDiacritics(this.value)" onchange="changeLineHeigthDiacritics(this.value)" style="width: 200px;" />
		<script type="text/javascript">
			function changeFontSizeDiacritics(newValue) {
				document.getElementById("changedfontsizeDiacritics").innerHTML=newValue;
				$('.changesizeDiacritics').css('font-size',newValue + 'px');
			};
			function changeLineHeigthDiacritics(newValue) {
				document.getElementById("changedlineheigthDiacritics").innerHTML=newValue;
				$('.changesizeDiacritics').css('line-height',newValue);
			};
		</script>
	</div>
	
	<p class="sizelabel">GF Latin Plus - <span id="changedfontsizeDiacritics">42</span>px / <span id="changedlineheigthDiacritics">1.2</span>em</p>
	<p class="changesizeDiacritics" style="font-size: 42px; line-height: 1.2em;">À Á Â Ã Ä Å Ā Ă Ą Ǻ Ȁ Ȃ Ạ Æ Ǽ Ć Ç Ĉ Ċ Č Ď Đ Ð È É Ê Ë Ē Ĕ Ė Ę Ẽ Ě Ẹ Ȅ Ȇ Ə Ĝ Ğ Ġ Ģ Ǧ Ĥ Ħ Ĭ Ì Í Î Ï İ Ĩ Ī Į Ị Ȉ Ȋ Ĵ   Ķ   Ĺ Ļ Ľ Ŀ Ł Ñ Ń Ņ Ň Ŋ Ò Ó Ô Õ Ö Ø Ō Ŏ Ő Ǿ Ǫ Ọ Ȫ Ȱ Ȭ Ȍ Ȏ Œ Þ Ŕ Ŗ Ř Ȑ Ȓ Ś Ŝ Š Ș Ş ẞ Ŧ Ť Ț Ţ Ù Ú Û Ü Ũ Ū Ŭ Ů Ű Ų Ụ Ȕ Ȗ Ẁ Ẃ Ẅ Ŵ Ý Ŷ Ÿ Ỳ Ỹ Ȳ Ź Ż Ž</p>	
	<p class="changesizeDiacritics" style="font-size: 42px; line-height: 1.2em;">à á â ã ä å ā ă ą ǻ ȁ ȃ ạ æ ǽ ć ç ĉ ċ č ď đ ð è é ê ë ē ĕ ė ę ě ẽ ẹ ȅ ȇ ə ĝ ğ ġ ģ ǧ ĥ ħ ì í î ï ĩ ī į ĭ ị ȉ ȋ ı ĵ ȷ ķ ĸ ĺ ļ ľ ŀ ł ń ņ ň ñ ŋ ò ó ô õ ö ø ō ŏ ő ǿ ǫ ọ ȍ ȏ ȫ ȱ ȭ œ þ ŕ ŗ ř ȑ ȓ ś ŝ š ș ş ß ŧ ť ț ţ ù ú û ü ũ ū ŭ ů ű ų ụ ȕ ȗ ẁ ẃ ẅ ŵ ý ÿ ŷ ỳ ỹ ȳ ź ż ž</p>	
	<p>&nbsp;</p>	

	<p class="sizelabel">GF Latin Plus Vietnamese</p>
	<p class="changesizeDiacritics" style="font-size: 42px; line-height: 1.2em;">Á Ă Ắ Ặ Ằ Ẳ Ẵ Â Ấ Ậ Ầ Ẩ Ẫ Ạ À Ả Ã Đ É Ê Ế Ệ Ề Ể Ễ Ẹ È Ẻ Ẽ Í Ị Ì Ỉ Ĩ Ó Ô Ố Ộ Ồ Ổ Ỗ Ọ Ò Ỏ Ơ Ớ Ợ Ờ Ở Ỡ Õ Ú Ụ Ù Ủ Ư Ứ Ự Ừ Ử Ữ Ũ Ý Ỵ Ỳ Ỷ Ỹ</p>
	<p class="changesizeDiacritics" style="font-size: 42px; line-height: 1.2em;">á ă ắ ặ ằ ẳ ẵ â ấ ậ ầ ẩ ẫ ạ à ả ã đ é ê ế ệ ề ể ễ ẹ è ẻ ẽ í ị ì ỉ ĩ ó ô ố ộ ồ ổ ỗ ọ ò ỏ ơ ớ ợ ờ ở ỡ õ ú ụ ù ủ ư ứ ự ừ ử ữ ũ ý ỵ ỳ ỷ ỹ</p>
	<p>&nbsp;</p>		

	<p class="sizelabel">GF Latin Pro</p>
	<p class="changesizeDiacritics" style="font-size: 42px; line-height: 1.2em;">Ḉ Ḍ Ḏ Ḕ Ḗ Ḝ Ḡ Ḥ Ḫ Ḯ Ḷ Ḻ Ṃ Ṅ Ṇ Ṉ Ṍ Ṏ Ṑ Ṓ Ṛ Ṟ Ṡ Ṣ Ṥ Ṧ Ṩ Ṭ Ṯ   Ṹ Ṻ Ẏ Ẓ</p>
	<p class="changesizeDiacritics" style="font-size: 42px; line-height: 1.2em;">ḉ ḍ ḏ ḕ ḗ ḝ ḡ ḥ ḫ ḯ ḷ ḻ ṃ ṅ ṇ ṉ ṍ ṏ ṑ ṓ ṛ ṟ ṡ ṣ ṥ ṧ ṩ ṭ ṯ ẗ ṹ ṻ ẏ ẓ</p>	
	<p>&nbsp;</p>
